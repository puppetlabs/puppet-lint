  ...
  def check
    manifest_lines.each_with_index do |line, idx|
      ...
      notify(
        ...
        :line        => idx + 1,
        :column      => 140,
        :description => 'Test the raw manifest string for lines containing more than 140 characters and record a warning for each instance found.  The only exceptions to this rule are lines containing URLs and template() calls which would hurt readability if split.',
